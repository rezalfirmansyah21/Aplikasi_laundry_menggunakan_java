...
new Timer(1000, taskPerformer).start();
    ...
    private void kode() {
        try {
            ...
            String sql = "SELECT * FROM paket ORDER by kode desc";
    ...
    private void initComponents() {
        ...
        btntambah.setForeground(new java.awt.Color(0, 153, 204));
        ...
        tabelpaket.setSelectionBackground(new java.awt.Color(0, 153, 204));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtnama, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 250, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnhapusActionPerformed
        ...
        try {
            String sql ="delete from paket where kode='"+txtid.getText()+"'";
        ...
        // TODO add your handling code here:
           if(txtid.getText().equals("") ||txtnama.getText().equals("") || txtharga.getText().equals("")){
            ...
            //    buttonGroup1.clearSelection();
                ...
                JOptionPane.showMessageDialog(null, "Data berhasil tersimpan", "Rumah Laundry", JOptionPane.INFORMATION_MESSAGE);
            }
        }
    ...
    private void btnubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnubahActionPerformed
        ...
        try {
            Connection c = koneksi.getKoneksi();
            String sql = "UPDATE paket SET nama_paket =  '" + txtnama.getText() + "',harga='" + txtharga.getText() + "' WHERE  kode ='" + idd + "'";
            PreparedStatement p = c.prepareStatement(sql);
            p.executeUpdate();
            p.close();
        } catch (SQLException e) {
    ...
    private void tabelpaketMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelpaketMouseClicked
     ...
     //   txtid.setEnabled(false);
        ...
        String hargaa = (String) model.getValueAt(i, 2);
    ...
    private void txtcariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcariKeyReleased
        ...
        try {
            ...
            String sql = "select * from paket where kode like '%" + txtcari.getText() + "%' or nama_paket like'%" + txtcari.getText() + "%' or harga like'" + txtcari.getText() +"%'";
            ResultSet r = s.executeQuery(sql);
