...
new Timer(1000, taskPerformer).start();
    ...
    private void initComponents() {
        ...
        txttelp.setForeground(new java.awt.Color(0, 153, 204));

        txtalamat.setColumns(20);
        txtalamat.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        txtalamat.setForeground(new java.awt.Color(0, 153, 204));
        txtalamat.setRows(5);
        ...
        tabelpelanggan.setSelectionBackground(new java.awt.Color(0, 153, 204));
    ...
    private void btnubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnubahActionPerformed
        ...
        try {
            Connection c = koneksi.getKoneksi();
            String sql = "UPDATE pelanggan SET nama =  '" + txtnama.getText() + "',no_telp='" + txttelp.getText() + "',alamat='" + txtalamat.getText() + "' WHERE  id ='" + idd + "'";
            PreparedStatement p = c.prepareStatement(sql);
            p.executeUpdate();
            p.close();
        } catch (SQLException e) {
    ...
    private void txtcariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcariKeyReleased
        ...
        try {
            ...
            String sql = "select * from pelanggan where id like '%" + txtcari.getText() + "%' or nama like'%" + txtcari.getText() + "%' or no_telp like'" + txtcari.getText() + "%' or alamat like'%" + txtcari.getText() +"%'";
            ResultSet r = s.executeQuery(sql);
